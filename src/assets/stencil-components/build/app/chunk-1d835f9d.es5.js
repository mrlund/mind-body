...
App.loadBundle("chunk-1d835f9d.js", ["exports"], function (e) { var n = window.App.h; var t = "/", r = "./", i = new RegExp(["(\\\\.)", "(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?"].join("|"), "g"); function o(e) { return e.replace(/([.+*?=^!:${}()[\]|/\\])/g, "\\$1"); } function a(e) { return e.replace(/([=!:$/()])/g, "\\$1"); } function s(e) { return e && e.sensitive ? "" : "i"; } function u(e, n, c) { return e instanceof RegExp ? function (e, n) { if (!n)
...
} return (l || d < e.length) && u.push(l + e.substr(d)), u; }(e, u), n, u); }(e, n, c); } var c = {}; var d = 0; var l = function (e, t) {
    ...
    return { Provider: function (_a) {
            ...
            return i.bind(this)(); }; } };
}(); var f = !("undefined" == typeof window || !window.document || !window.document.createElement); e.matchPath = function (e, n) {
    if (n === void 0) { n = {}; }
...
}, e.ActiveRouter = l, e.storageAvailable = (function (e) { try {
